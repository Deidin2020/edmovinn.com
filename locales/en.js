export default {
  ...
  'footer': {
    ...
    'quickLinksTitle': ' ',
    'housingContract': 'Housing Contract & Regulations (Arabic PDF)',
    'contact': {
  ...
  accommodation: {
    ...
    room_about: 'About the room',
    about_room: 'About the room',
  ...
  labels: {
    ...
    no_results_try_agin: 'No results found for your search. Please try again with different filters.'
  },
  actions: {
    sign_up: 'Sign Up',
    verify: 'Verify',
    ...
    apply: 'Apply',
    addToDraft: 'Save Application',
    cancel: 'Cancel',
    ignore: 'Ignore It',
    next: 'Next',
    skip: 'Skip',
    book_now: 'Book now',
    book_close: 'Booking closed',
    search: 'Search',
    resend: 'Resend',
    complete_profile: 'Complete Profile',
    continue: 'Continue',
    more_details: 'Start Your Search Journey',
    contact_us: 'Get a free Consultation',
    login: 'Login',
    explore_your_options: 'Explore Your Options',
...
pages: {
  sign_up: {
    ...
    description: 'Enter your details to create an account on Edmov platform'
  },
  login: {
    title      : 'Login',
  ...
  verify: {
    ...
    did_not_receive_code: 'Didn’t receive the verification code?'
  },
  changeMobile: {
    title        : 'Change Your Mobile Number',
    description  : 'Fill in the field below to change your mobile number',
    note_discount: 'Change your mobile number'
  },
  forgotPassword: {
  ...
  checkout: {
    ...
    personal_info_description: 'Please fill in your personal details',
    emergency_contact_title: 'Emergency Contact Information',
    emergency_contact_description: 'Please provide an emergency contact person',
    continue_button: 'Continue to Terms & Conditions'
  }
},
payment_methods: {
  bank_transfer: {
...
login_with_facebook: 'Login with Facebook',
  ...
  sing_up            : 'Sign Up',
  sing_up_new        : 'Create a New Account',
  sing_in            : 'Sign In',
